...
#
# Should we include the "Overall design" field from GEO in our search?
#   Maybe not if these are not consistent among datasets...
...
#python3 sciSpacyModelCreation.py "$all_geo_json_file_path" #TODO:fix me
