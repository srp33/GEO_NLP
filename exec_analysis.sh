...
# We do this beforehand to avoid doing it multiple times and it's kinda slow.
#python3 extractKeywords.py "$all_geo_json_file_path" "$queries" "$multiplication_rates" "$num_keyword_options" TODO: do we want to include this? To what extent?

#Creates cbow and skipgram fasttext models. 
