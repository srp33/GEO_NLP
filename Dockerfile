...
RUN pip3 install --upgrade pip setuptools wheel \
 && pip3 install geofetch==0.12.5 bs4==0.0.2 gemmapy==0.0.2 scikit-learn==1.4.0 \
                 ...
                 chromadb==0.4.22 openai==1.12.0 fasttext==0.9.3 gensim==4.3.2 einops==0.7.0 \
                 joblib==1.3.2 nltk==3.8.1 langchain-text-splitters==0.0.1 bm25s[full]==0.2.14 PyStemmer==3.0.0
